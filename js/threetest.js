    ...
    $(function () {
        ...
        function generateSprite() {
            ...
            gradient.addColorStop(0, 'rgba(255,255,255,1)'); // rgba(0,0,0,1)
            gradient.addColorStop(0.2, 'rgba(0,255,255,1)'); // rgba(128,128,128,1)
            gradient.addColorStop(0.4, 'rgba(0,0,64,1)'); // rgba(rgba(200,200,200,1))
            gradient.addColorStop(1, 'rgba(0,0,0,1)'); // rgba(255,255,255,1)
