    ...
    $(function () {
        ...
        function generateSprite() {
            ...
            gradient.addColorStop(0, 'rgba(255,255,255,1)'); // rgba(255,255,255,1)
            gradient.addColorStop(0.2, 'rgba(200,200,200,1)'); // rgba(0,255,255,1)
            gradient.addColorStop(0.4, 'rgba(128,128,128,1)'); // rgba(0,0,64,1)
